...
//
// Public fields of _samlsp.Middleware_ have changed, so some usages may require adjustment. See [issue 231](https://github.com/kevcoxe/saml/issues/231) for details.
//
